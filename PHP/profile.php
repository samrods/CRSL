<?php 
/*------------------------------------------------*/
/*-- PHP to enable navigation to user's profiles--*/
/*------------------------------------------------*/
    ...
    // Reassign values to prevent null values
    if (empty($noOfApps)) {
       $noOfApps = '0';
    } 
    if (empty($noOfGoals)) {
    ...
    */
    ...
    // Reassign value to prevent null value
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script type="text/javascript">
      ...
      // DRAW COMBO Chart (bar chart with averages)
...
<body>
    ...
    <div class="form"> 
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
            <!--Show any errors when editing profile-->
    ...
    <!--Google Charts with personalised data-->
    ...
    <div class="grid_index">
        <div class="gallery">
            <!--Top goal scorers with average-->
            <?php 
                // display graph only if there is data
                if($result5->num_rows > 0){ ?>
                  <div id="chart_div" class="gc_graph"></div><?php
                }
            ?>
        </div>
    </div>
    <div class="grid_index">
        <div class="gallery">
            ...
            <?php 
                if($result7->num_rows > 0){ ?>
                  <div id="curve_chart" class="gc_graph"></div><?php
                }
            ?>
        </div>
    </div>

<?php 
/*---------------------------------------------*/
/*-- PHP for gallery page - display profiles --*/
/*---------------------------------------------*/
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <!-- External sources -->
    <link rel="shortcut icon" type="image/png" href="logo.png"/>                <!--webiste favicon-->
	<script src="https://kit.fontawesome.com/6241a865f7.js" crossorigin="anonymous"></script>	                        <!--menu favicons-->
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/emailjs-com@2.3.2/dist/email.min.js"></script>     <!--Email library-->
...
<body>
    ...
    <h2 class="sub_title">Players Profiles</h2>
        ...
        <?php
            ...
            if (mysqli_num_rows($results) > 0) {
              while($row = $results->fetch_assoc()) {
                    ...
                    /*Reassign values to prevent null references*/
                    if (empty($noOfApps)) {
                        $noOfApps = '0';
                    } 
                    if (empty($noOfGoals)) {
